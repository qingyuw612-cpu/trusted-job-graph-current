    ...
    def test_reuses_driver_and_role_cache(self, monkeypatch):
        records = [
            {
                ...
                "skills": [
                    ...
                    {"name": "Python", "category": "技术", "weight": 0.8, "rank": 2},
                ],
            }
        ]
        ...
        class FakeSession:
            ...
            def run(self, cypher):
                ...
                assert "NormalizationPointer {name:'core'}" in cypher
                assert "run_id:run.run_id" in cypher
        ...
        assert [skill["name"] for skill in first[0]["skills"]] == ["Python"]
